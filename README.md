...
SoulNPC — это плагин для NPC с удобной GUI-настройкой каждого на сервере. Плагин создан, чтобы быть простым, но в то же время функциональным и отзывчивым — без головной боли у администраторов и без огромной тонны настроек. Все рутинные аспекты вынесены в GUI-меню: там можно настроить практически все визуальные и интерактивные параметры каждого NPC.

## О плагине

**SoulNPC** — бесплатный плагин NPC для серверов **Minecraft** на **Paper 1.21+**. Он подойдёт администраторам, которым нужно быстро расставить NPC на спавне, в магазине, на ивенте или в хабе: создать NPC, задать внешний вид, голограмму с именем и настроить реакцию на клик — без правки десятков конфигов вручную.

NPC отображаются через пакеты (packet NPC): модель игрока или моба, голограмма на **TextDisplay**, скин по нику, URL или **SkinRestorer**, экипировка, свечение, анимации и поворот к игроку. Клики **ПКМ**, **ЛКМ**, **СКМ** и с **Shift** можно привязать к сообщениям, командам, консольным действиям и переходу на другой сервер в сети. Есть поддержка **PlaceholderAPI**, хранение в **YAML**, **SQLite** или **MySQL**, русский и английский интерфейс, а также совместимость с **Geyser** для игроков с Bedrock.

Если вы ищете плагин для NPC на Paper с понятным редактором в игре, а не только через yaml — SoulNPC как раз про это: один NPC — одно меню, все основные настройки под рукой.
